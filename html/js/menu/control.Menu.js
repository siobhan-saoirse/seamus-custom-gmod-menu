...
function MenuController( $scope, $rootScope )
{
	...
	$scope.Disconnect = function()
	{
		...
		lua.Run(`local audio = 'ui/gamestartup'..math.random(1,29)..'.mp3' RunConsoleCommand('play',audio)`)
	}
	
	$scope.PlayerList = function()
	{
		lua.Run( "RunConsoleCommand( 'gamemenucommand','openplayerlistdialog' )" );
	}
	
	$scope.PlayMoreMusic = function()
	{
		lua.Run( "RunConsoleCommand( 'stopsound' )" );
		lua.Run( "RunConsoleCommand('play', 'tf2/ui_click.wav')" )
		lua.Run(`local audio = 'ui/gamestartup'..math.random(1,29)..'.mp3' RunConsoleCommand('play',audio)`)
	}
...
// Setup sounds..
//
$(document).on( "mouseenter", ".options a",			function() { lua.PlaySound( "tf2/ui_hover.wav" ); } );
$(document).on( "click", ".options a",				function() { lua.PlaySound( "tf2/ui_click.wav" ); setTimeout(()=>{lua.PlaySound( "tf2/ui_clickrelease.wav" );},100);} );
$(document).on( "mouseenter", ".noisy",				function() { lua.PlaySound( "tf2/ui_hover.wav" ); } );
$(document).on( "click", ".noisy",					function() { lua.PlaySound( "tf2/ui_click.wav" ); setTimeout(()=>{lua.PlaySound( "tf2/ui_clickrelease.wav" );},100); } );
$(document).on( "mouseenter", ".ui_sound_return",	function() { lua.PlaySound( "tf2/ui_hover.wav" ); } );
$(document).on( "click", ".ui_sound_return",		function() { lua.PlaySound( "tf2/ui_click.wav" ); setTimeout(()=>{lua.PlaySound( "tf2/ui_clickrelease.wav" );},100); } );
